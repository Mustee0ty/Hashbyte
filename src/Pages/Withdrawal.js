...
const Withdrawal = () => {
  ...
  return (
    <section className='mx-auto flex flex-col w-[360px] h-[800px] bg-gradient-to-b from-purple-700 via-purple-900 to-indigo-900 text-white relative'>
      ...
      <div className='h-[600px] w-full bg-white rounded-t-[44px] flex flex-col mx-auto relative'>
       ...
       <div className='flex flex-col'>
        <p className='text-[#5B63E6] text-[30px] font-bold my-[20px] mx-auto'> 0.45789 BTC</p>
        <div className='px-[15px]'>
          <p className='text-[#9192A1] text-[15px] leading-[25px] mb-[5px]'>Enter an amount</p>
          <div className='relative flex flex-row'>
          <input className='w-[330px] h-[56px] rounded-[28px] border-[1px] focus:border-[1px] ' type="text" />
          <button className='absolute text-[#5B63E6] right-0 mr-[21px] font-[700] top-[25%]'>Max</button>
          </div>
          <div className='flex flex-row justify-evenly'>
            {
              amountBubbles.map((bubble) =>{
                ...
                return (
                  <button className='bg-[#EEEEEE] mt-[14px] flex items-center align-middle justify-center hover:bg-[#d5d1d1] h-[32px] w-[51px] rounded-[16px] text-black font-semibold' key={id}>
                    {amount}
                  </button>
                )
              })
          ...
          <div className='mt-[40px]'>
            <p className='text-[#9192A1] text-[15px] leading-[25px] mb-[5px]'>Enter an address</p>
            <div className='relative flex flex-row'>
            <input className='w-[330px] h-[56px] rounded-[28px] border-[1px] focus:border-[1px] ' type="text" />
            <button className='absolute text-[#5B63E6] right-0 mr-[21px] font-[700] top-[25%]'>Paste</button>
            </div>
          </div>
          {/* Chain name */}
          ...
          <div className='rounded-[7px] flex items-center align-middle justify-center h-[45px] w-[330px] bg-[#efe5e5]'>
            <p className='text-[#ff4141] text-[13px] leading-[16px] font-semibold flex items-center align-middle justify-center'>Please don't withdraw to any other address except BTC or you may lose it </p>
          </div>
