...
const Profile = () => {
  return (
    <section className="w-[360px] h-screen bg-blue-100 mx-auto">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col bg-blue-100 ">
              ...
              <div className="flex flex-row justify-center items-center mx-auto align-middle gap-x-[12px] ">
                <div className="w-[159px] h-[81px] rounded-[10px] border-[1px] border-[#5b63e6] flex flex-col  justify-center ">
      ...
      {/* Setting Options */}
      <div className="flex flex-col mt-[50px] align-middle items-center justify-center bg-blue-100 ">
        ...
        <div className="flex flex-row h-[57px] rounded-[10px] w-[330px] mt-[33px] bg-white align-middle items-center mx-[30px]">
