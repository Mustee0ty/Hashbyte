  ...
  return (
    ...
    <div className='h-[600px] w-full bg-white rounded-t-[44px] flex flex-col mx-auto relative'>
     ...
     <div className='flex flex-col h-full'>
      <p className='text-[#5B63E6] text-[20px] h-[35px] leading-[35px] font-bold mt-[20px] mb-[43px] mx-auto'> Security Verification </p>
      <div className='px-[15px] h-full'>
        <p className='text-[#9192A1] text-[15px] leading-[25px] mb-[5px]'>Enter verification code </p>
        <div className='relative flex flex-row'>
        <input className='w-[330px] h-[56px] rounded-[28px] border-[1px] focus:border-[1px] ' type="text" />
        <button className='absolute text-[#5B63E6] right-0 mr-[21px] font-[700] top-[25%]'>Get code </button>
        </div>
        <p className='text-gray-400 mt-[8px]'>6-digit code sent to ab***gmail.com</p>
