      ...
      <div className='flex flex-row justify-evenly items-center align-middle bg-white w-[365px] h-full'>
        {
          NavIcons.map((icons) => {
            ...
            return (
            <div className='h-[50px] w-[50px] flex justify-center items-center hover:bg-gradient-to-r from-navPrimary to-navSecondary hover:rounded-full hover:translate-y-[-17px] transition-transform duration-300' key={id}>
              <Link to={url}>
